...
const DEFAULT_SETTINGS = {
  ...
  timeout: {
    ...
    internal_llm: { value: 120, type: 'number', description: 'Internal LLM 请求超时（秒）' },
    external_http: { value: 120, type: 'number', description: 'External HTTP 请求超时（秒）' },
    mcp_request: { value: 120, type: 'number', description: 'MCP 请求超时（秒）' },
    embedding: { value: 120, type: 'number', description: 'Embedding 请求超时（秒）' },
  ...
  app: {
    ...
    tick_warn_after_ms: { value: 1200000, type: 'number', description: 'Tick 运行时长告警阈值（毫秒），仅用于观察和前端高亮' },
...
const VALIDATION_RULES = {
  ...
  'timeout.internal_llm': { min: 30, max: 1800 },
  'timeout.external_http': { min: 30, max: 600 },
  'timeout.mcp_request': { min: 30, max: 1800 },
  'timeout.embedding': { min: 30, max: 1800 },
  ...
  'app.tick_warn_after_ms': { min: 60000, max: 3600000 },
