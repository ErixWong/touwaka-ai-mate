export default {
  ...
  settings: {
    ...
    noUsers: 'No users yet. Click the button above to add one.',
    noUsersFound: 'No matching users found',
    searchUsers: 'Search users...',
    searchUsersPlaceholder: 'Search by username, email or nickname...',
    ...
    roleList: 'Role List',
    roleName: 'Role Name',
    roleLabel: 'Display Name',
    roleLabelPlaceholder: 'Enter display name',
