...
thinkingFormatDeepseek: 'DeepSeek/GLM Format',
    ...
    internalLlmTimeoutHint: 'Maximum total duration for a single internal LLM call from start to full completion (seconds)',
  ...
  appClock: {
    ...
    clearSuccessIdle: 'Timeout state cleared, scheduling resumed',
    clearSuccessRecovering: 'Timeout state cleared, waiting for running tick to settle',
    clearFailed: 'Failed to clear timeout state',
    forceTickSuccess: 'Tick triggered',
    forceTickFailed: 'Failed to trigger tick',
    timedOutWarning: '{count} app(s) are in timed out state and require administrator attention',
  },
}
