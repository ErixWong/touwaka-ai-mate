...
thinkingFormatDeepseek: 'DeepSeek/GLM Format',
    ...
    resident: {
      title: 'Resident Process Status',
      description: 'View and manage resident skill processes that auto-start with the system',
      ...
      errorCount: 'Errors',
      lastInvoke: 'Last Invoke',
      invokeSummary: 'Invoke Summary',
