...
export default {
  ...
  async process(context) {
    ...
    if (llmStepConfig.model_id) llmParams.model_id = llmStepConfig.model_id;
    ...
    if (existing) {
      ...
      return {
        success: true,
        data: { invoice_number: data.invoice_number, duplicate: true, existing_row_id: existing.row_id },
      };
    }
