import { estimateMessagesTokens, estimateTokens } from '../token-utils.js';
...
export class ContextResult {
  ...
  estimateTokens() {
    ...
    return estimateMessagesTokens(messages) + (hasSystemMessage ? 0 : estimateTokens(this.systemPrompt));
  }
