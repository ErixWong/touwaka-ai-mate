...
class DocumentChunkService {
  ...
  async _loadRevisionText(revision) {
    ...
    const metadata = parseMetadataObject(ocrResult.metadata);
    const preferredAttachmentId = metadata.cleaned_markdown_attachment_id || ocrResult.main_markdown_attachment_id;
