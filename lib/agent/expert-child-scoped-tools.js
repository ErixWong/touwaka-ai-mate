...
function buildChildToolContext({ invocation_context, session, taskContext = null }) {
...
export async function getExpertChildScopedTools({
  ...
  const toolContext = buildChildToolContext({ invocation_context, session, taskContext });
