...
class DocumentOutlineService {
  ...
  async _extractSingleChunk(callLlm, text, maxLevel, temperature, modelId) {
  ...
  async _extractMultiChunk(callLlm, text, windowSize, stepSize, maxLevel, temperature, modelId, deduplicateTitles) {
