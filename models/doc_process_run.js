    ...
    return super.init({
      ...
      indexes: [
        ...
        },
        {
          ...
          using: 'BTREE',
          fields: [{ name: 'revision_id' }, { name: 'started_at' }]
        },
        {
          name: 'idx_step_result',
          using: 'BTREE',
          fields: [{ name: 'pipeline_step' }, { name: 'result_status' }, { name: 'started_at' }]
        },
        {
          name: 'idx_subject_started',
          using: 'BTREE',
          fields: [{ name: 'subject_type' }, { name: 'subject_id' }, { name: 'started_at' }]
        }
      ]
    });
  }
