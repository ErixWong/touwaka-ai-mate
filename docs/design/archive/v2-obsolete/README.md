...
参见新设计文档：
- [`docs/design/core/phase2/skill-management-tools-design.md`](../../core/phase2/skill-management-tools-design.md) - 技能管理工具设计
- [`docs/design/core/phase2/skill-import-dialog-design.md`](../../core/phase2/skill-import-dialog-design.md) - 对话式导入界面设计
...
- [`skill-configuration-design.md`](../../core/phase2/skill-configuration-design.md) - 技能参数配置（仍在使用）
- [`skill-management-tools-design.md`](../../core/phase2/skill-management-tools-design.md) - register_skill 工具设计
- [`skill-import-dialog-design.md`](../../core/phase2/skill-import-dialog-design.md) - 新的对话式界面设计
